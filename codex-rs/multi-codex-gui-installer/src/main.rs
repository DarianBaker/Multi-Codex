...
pub struct InstallerApp {
    #[nwg_control(size: (440, 240), position: (300, 300), title: "Multi-Codex Installer", flags: "WINDOW|VISIBLE")]
    ...
    #[nwg_control(parent: window, text: "Installs multi-codex, codex-quota-proxy, codex, and codex-code-mode-host, and adds them to your PATH.", position: (15, 45), size: (410, 65))]
    description_label: nwg::Label,

    #[nwg_control(parent: window, text: "Install", position: (15, 120), size: (120, 32))]
    #[nwg_events(OnButtonClick: [InstallerApp::on_install])]
    install_button: nwg::Button,

    #[nwg_control(parent: window, position: (15, 165), size: (410, 20))]
    progress_bar: nwg::ProgressBar,

    #[nwg_control(parent: window, text: "", position: (15, 192), size: (410, 30))]
    status_label: nwg::Label,

    #[nwg_control(parent: window, text: "Close", position: (320, 192), size: (105, 30))]
